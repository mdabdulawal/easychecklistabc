				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->							
							{{ Form::open(array('route' => 'create-new-task', 'class' => 'form-horizontal')) }}
								<div class="form-body">
									<div class="form-group">										
										{{ Form::label('checklist_id', 'Checklist Name', array('class' => 'col-md-3 control-label')) }}
										<div class="col-md-6">
											{{ Form::select('checklist_id', array('' => '-- Select Checklist --')+$checklists, null, array('class' => 'form-control select2me', 'required' => 'required')) }}
										</div>
									</div>
									<div class="form-group">										
...
@section('script')
<script>
	$("body").on('change', '#checklist_id', function() { 
		var checklistId =  $('#checklist_id').val();
	  if(checklistId!=''){
	        $.ajax({
	            type : 'get',
	            url : 'get-client-List-by-checklist',
	            data : {
