	...
	<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Checklist <small>copy existing checklist data</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Form :: Copy a checklist
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->							
							{{ Form::model($checklist,array('route' => array('checklist.copy', $checklist->id), 'class' => 'form-horizontal')) }}
								<div class="form-body">
									<div class="form-group">										
										{{ Form::label('title', 'Checklist Name', array('class' => 'col-md-3 control-label')) }}
										<div class="col-md-6">											
											{{ Form::text('title', null.' '.$checklist->title, array('placeholder' => 'Type checklist name', 'required' => 'required', 'class' => 'form-control input-circle')) }}
										</div>
									</div>
									<div class="form-group">										
									...
									<div class="form-group">										
										...
										<div class="col-md-6">
											{{ Form::select('client_id', array('' => '-- Select Client Name --')+$clients, null, array('class' => 'form-control select2me', 'required' => 'required')) }}
										</div>
									</div>
									<div class="form-group">										
