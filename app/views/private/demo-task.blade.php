			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="{{URL::route('demo-templates')}}">Checklist</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li>
							<a href="#">Task</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Form :: Add New Task To Demo Checklist
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->							
							{{ Form::model($checklist, array('route' => 'create-new-demo-task', 'class' => 'form-horizontal')) }}
								<div class="form-body">
