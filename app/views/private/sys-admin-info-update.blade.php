				...
				<div class="col-md-5">
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>Form :: Update Information
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->							
							{{ Form::model($user, array('route' => array('sys-admin.update', $user->id), 'class' => 'form-horizontal')) }}
								<div class="form-body">
									...
									<div class="form-group">										
										...
										<div class="col-md-6">											
											{{ Form::password('password', array('placeholder' => '******', 'class' => 'form-control input-circle')) }}
										</div>
									</div>																	
								</div>
