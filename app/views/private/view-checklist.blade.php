					...
					{{ Form::open(array('route' => 'filter-checklist', 'class' => 'form-horizontal')) }}
						...
						<!--BEGIN FORM-->
							...
							<div class="form-body">						
								<div class="form-group">																		
									<div class="col-md-8">
										{{ Form::select('filter_by', array('' => '-- Filter By --', 'due_date' => 'Due Date', 'company_name' => 'Client Name', 'checklist' => 'Checklist', 'username' => 'User Name', 'completed' => 'Completed'), null, array('class' => 'form-control select2me')) }}									
									</div>
									<div class="col-md-3">									
						...
						<div class="col-md-6">	
							...
							<div class="form-body">						
								<div class="form-group">																		
									<div class="col-md-8">											
											{{ Form::text('search_by', null, array('rows' => '3','placeholder' => 'Search Task List', 'class' => 'form-control input-circle')) }}
										</div>
									<div class="col-md-3">									
